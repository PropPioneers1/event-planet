...
const ContactUs = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_u09zdz6", "template_9ps8lsj", form.current, {
  ...
  return (
    <div>
      <div
        className="hero min-h-[70vh] bg-cover  "
        style={{
          backgroundImage:
            "url(https://theroxysaskatoon.com/home/wp-content/uploads/2023/05/bg-23052201.jpg)",
        }}
      >
      ...
      <Container>
        <div>
          <div
            className="mt-20 p-10 bg-cover"
            style={{ backgroundImage: "url(https://shorturl.at/ayMU3)" }}
          >
            <div className="text-white">
              <SectionHeading
                title="Meet Support"
                normalSubTitleWord="Contact With Our "
                boldSubTitleWord="Event Planner"
              ></SectionHeading>
            </div>
            <div className="flex justify-center text-white">
              <div className="border-4 rounded border-opacity-50 border-[#eeeeee] p-5 md:p-8 lg:p-10 col-span-1 md:col-span-2 md:w-full glass">
                <form onSubmit={formData} className="max-w-xl mx-auto">
                  <div className="py-4">
                    <div id="eventDetails">
                      <h1 className="text-lg text-center font-title text-black">
                        Contact with our event planner 9:00 PM to 11:00 PM
                      </h1>
                      {jsonData
                        ?.filter(
                        ...
                        .map((event) => (
                          <div
                            className="text-center text-lg space-y-1"
                            key={event.id}
                          >
                            <h1 className="text-xl mb-3 font-title">
                              Your Meet Supporter
                            </h1>
                    ...
                    <div className="py-4 space-y-3">
                      <select
                        ...
                        name="optionCategory"
                        className="bg-gray-50 border text-gray-900 border-primary rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 text-lg"
                      >
                      ...
                      <textarea
                        ...
                        className="textarea textarea-bordered textarea- w-full max-w-full border-primary text-black"
                        required
                      ></textarea>
                    </div>
                          ...
                          {meetData
                            ...
                            .map((event, idx) => (
                              <a
                                key={idx}
                                className={`btn ${
                                  formSubmitted ? "bg-primary" : "bg-gray-300"
                                } border text-white hover:bg-primary`}
