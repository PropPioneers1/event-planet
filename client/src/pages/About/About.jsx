...
<Container>
<div className=" grid py-32 w-full
...
<h1 className='font-bold text-3xl tracking-[0.2rem] mb-5'> Our Mision</h1>
 <div className="w-16 bg-accent h-[.35rem]  mt-6"></div>
</div>
<div>
  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Harum et odit aspernatur magni aliquam distinctio vero voluptate cumque consectetur minima quia, laborum ab id accusamus dignissimos laboriosam soluta ipsum illo?
Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus eaque recusandae saepe fugiat ratione cum aspernatur molestias vitae tempore. Minus quod molestias ea maxime eos fugiat consequuntur veniam odio obcaecati!
  </p>
</div>
        </div>
        <div className="grid">
<div className="flex gap-2  ">
<h1 className='font-bold text-3xl tracking-[0.2rem] mb-5'> Our Vision</h1>
 <div className="w-16 bg-accent h-[.35rem]  mt-6"></div>
</div>
<div>
  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Harum et odit aspernatur magni aliquam distinctio vero voluptate cumque consectetur minima quia, laborum ab id accusamus dignissimos laboriosam soluta ipsum illo?
   ...
   />
    ...
    <div className="bg-white bg-opacity-80  p-4">
      <p className="text-black text-center font-bold">
        Event planet<br/>Working Since 2024
      </p>
    </div>
    </div>
    </div>
    ...
    <ul className="">
 <li>
 <div className="h-72  lg:max-w-[500px]
  ...
  <h1 className="text-sm lg:pl-4 w-20 md:pl-2 lg:w-96 font-bold
   h-8 border-b-secondary border-b-2 text-accent  relative">
    AUG 2015
    <div className="absolute  right-full transform 
    translate-x-3/4 -translate-y-2/4">
   
    </div>
  </h1>
  <div className="pl-3 ">
    <h1 className="mb-2  text-start text-sm md:text-xl lg:text-2xl font-bold">1st Place For Unique Events 2018</h1>
    <p className=" md:w-96 w-64 text-xs">
      Lorem ipsum dolor sit amet, loremconsectetuer adipiscing elit diam sed diam nonummy nibh euismod
      tincidunt. loremconsectetuer adipiscing elit diam sed diam nonummy nibh euismod tincidunt.
    </p>
  </div>
</div>
...
<div className=" mx-auto lg:h-[500px] md:h-[580px]  h-[800px] pt-10 bg-cover bg-no-repeat
 bg-[hsl(233,24%,93%)]  bg-blend-overlay  "
style={{  backgroundImage: 'url("https://i.ibb.co/2qd2xfP/pexels-eberhard-grossgasteiger-691668.jpg")' }}>
...
<div className="w-full p-4 mb-20 bg-accent h-44 grid grid-cols-4 justify-center align-middle items-center">
  ...
  <h1 className="text-2xl lg:text-5xl text-white">Looking For <span className="font-semibold "> Something Special For Your Moment?</span></h1>
  <p>Contact us now and we will make your event unique & unforgettable</p>

  </div>
  <div>
  <button className="btn btn-ghost rounded-3xl w-44 bg-white
   hover:text-white hover:bg-primary">Contact us</button>
</div>
</div>
