        ...
        <div className="pb-8 p-4">
          <div className="">
            <div className="count-down-time">
              <p className="text-slate-500 my-4 pt-8">
                {date} || {time}
              </p>
              <p className=" days absolute top-[150px] md:top-[196px] lg:top-40 text-center items-center flex left-5 text-white px-3 py-2 bg-accent font-medium rounded-full w-20 h-20">
                {countdownTimer}
              </p>
            </div>
            <p className="text-lg font-bold mb-2 text-black inline-block">
              {eventName}
            </p>
            <hr />
