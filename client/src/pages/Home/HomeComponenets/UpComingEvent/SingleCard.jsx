        ...
        <div>
          <div className="relative border group rounded shadow-lg overflow-hidden imgparent w-full">
            ...
            <div className="absolute inset-0 bg-black bg-opacity-70 opacity-0 group-hover:opacity-100 transform scale-y-0 group-hover:scale-y-100 transition-transform duration-500">
                <button className="absolute top-1/2 left-[30%] transform -translate-x-1/2 -translate-y-1/2 text-white button px-4 py-3 rounded flex items-center text-lg font-semibold">Book <FaBookmark className="ml-2"></FaBookmark></button>
                <button className="absolute top-1/2 left-[200px] transform -translate-x-1/2 -translate-y-1/2 text-white px-4 py-3 rounded flex items-center text-lg font-semibold button">More<MdOutlineArrowOutward className="animate-bounce ml-2"></MdOutlineArrowOutward> </button>
            </div>
            ...
            <div className="pb-8 p-4">
              <div className="">
                <div className="count-down-time">
                  ...
                  <p className=" days absolute top-40 text-center items-center flex left-3 text-white px-3 py-2 bg-accent font-medium rounded-full w-20 h-20">{countdownTimer}</p>
                </div>
