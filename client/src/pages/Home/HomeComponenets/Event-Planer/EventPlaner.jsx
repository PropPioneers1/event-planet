		...
		<div className="mt-5">
			...
			<div className="w-full lg:w-3/4 gap-5 mb-5  mt-10 grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3  mx-auto">
				{eventPlaner?.map((event, idx) => (
					<div
						key={idx}
						className="text-center  relative mt-14 mb-3 border-[#F53F7B] border-2  rounded-lg space-y-1 p-5"
					>
						<img
							className="h-[150px] object-cover  absolute left-1/2 -top-20 -translate-x-1/2 w-[150px]  border-2 border-[#F53F7B] p-1 rounded-full"
							src={event?.photoUrl}
							alt=""
						/>

						<div className="pt-10">
							<h1 className="text-xl mt-1 font-title font-medium">
  ...
  return (
    <div className="mt-5">
      <div className="text-center mx-auto md:w-6/12 lg:w-4/12 text-center my-8">
        <h1 className="text-3xl font-title font-semibold">Our Event Planer</h1>
        <p className="text-xl font-title border-y-2 border-[#F53F7B]  py-4 mt-2">
          Learn more about the Planer of Event Planet
        </p>
      </div>
        ...
        {eventPlaner?.map((event, idx) => (
          <div className="text-center border mt-5 mb-3 p-5 border-[#F53F7B] border-2  rounded-lg space-y-1 p-5">
            <div className="mt-[-60px]">
              <img
                className="h-[150px] object-cover ml-[90px] w-[150px] border border-2 border-[#F53F7B] p-1 rounded-full"
                src={event?.photoUrl}
                alt=""
              />
            </div>
...
>>>>>>> dd7e9204ec196470e446d1023a8efe8ec3cc0a74
};
