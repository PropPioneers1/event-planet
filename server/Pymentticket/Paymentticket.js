...
router.post("/paymentticket", async (req, res) => {
  ...
  const sslczData = {
    ...
    success_url: `https://server-orpin-alpha.vercel.app/ticketpay/success/${datasfront.tran_id}`,
    fail_url: `https://server-orpin-alpha.vercel.app/ticketpay/failure/${datasfront.tran_id}`,
